...
DEFAULT_CONFIG = {
    ...
    # K-line data start date (YYYY-MM-DD). Used when fetching OHLCV data.
    # Can be overridden via environment variable TRADINGAGENTS_KLINE_START_DATE.
    "kline_start_date": os.getenv("TRADINGAGENTS_KLINE_START_DATE", "2024-01-01"),
